...
As I mentioned, I love working on visualizing numbers, so you can expect some additional interesting stats in the future. Drop me a dm for ideas if any. (X, bluesky), and thanks for reading through. Tap for hi five.

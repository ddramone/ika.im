...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    blockquote: ({ children }) => <blockquote className="ml-8 pl-8 font-italic italic text-lg border-l border-opacity-20 border-black">{children}</blockquote>,
    ...
    em: ({ children }) => <em className="font-italic italic">{children}</em>,
    img: (props: any) => 
      <>
